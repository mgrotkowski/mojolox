...
trait Visitor:
   fn visitExpressionStmt(inout self, inout Expressionstmt : StmtExpression) raises -> None: ...
   fn visitPrintStmt(inout self, inout Printstmt : StmtPrint) raises -> None: ...
   fn visitVarStmt(inout self, inout Varstmt : StmtVar) raises -> None: ...
   fn visitBlockStmt(inout self, inout Blockstmt : StmtBlock) raises -> None: ...
   fn visitIfStmt(inout self, inout Ifstmt : StmtIf) raises -> None: ...
   fn visitWhileStmt(inout self, inout Whilestmt : StmtWhile) raises -> None: ...
   fn visitFunctionStmt(inout self, inout Functionstmt : StmtFunction) raises -> None: ...
   fn visitReturnStmt(inout self, inout Returnstmt : StmtReturn) raises -> None: ...
